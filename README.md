...
summary, PVOutput state, data-quality status, energy-balance status, and tonight
risk planner data used by the dashboard. The built-in dashboard server exposes
it at `/dashboard.json` without making another Growatt API call.
