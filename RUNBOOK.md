...
energy-balance status, and tonight risk planner data for monitors or future
apps. The built-in dashboard server serves it at `/dashboard.json` without
making another Growatt API call.
